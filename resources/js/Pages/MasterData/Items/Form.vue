...
const sections = computed(() => [
    {
        ...
        fields: [
            ...
            { key: 'item_category_id', label: 'Category', type: 'select', options: categories, valueKey: 'id', labelKey: 'name', required: true },
    ...
    },
    {
        ...
        rule: 'BR-2 · BR-25',
        fields: [
            { key: 'base_uom_id', label: 'Base UoM', type: 'select', options: uoms, valueKey: 'id', labelKey: 'code', required: true },
            { key: 'purchase_uom_id', label: 'Purchase UoM', type: 'select', options: uoms, valueKey: 'id', labelKey: 'code' },
            { key: 'default_supplier_id', label: 'Default supplier', type: 'select', options: suppliers, valueKey: 'id', labelKey: 'name' },
