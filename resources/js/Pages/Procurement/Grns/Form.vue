...
<template>
    <AppLayout>
        ...
        <template #actions>
            <Button href="/grns">Cancel</Button>
            <Button variant="primary" :loading="form.processing" @click="submit">Receive &amp; post</Button>
        </template>
            ...
            <Card title="Lines" rule="I5 · Gate 2" :padded="false">
                <div class="p-3">
                    <LineItemsTable
                        ...
                        :errors="form.errors"
                        add-label="Add line"
                        empty="A goods receipt needs at least one line."
                        @add="addLine"
                        @remove="removeLine"
                    >
                        ...
                        <template #cell:qty="{ line }">
                            <div class="flex gap-1">
                                <TextInput v-model="line.qty" type="number" step="0.000001" numeric />
                                <SelectInput
                                    v-model="line.uom_id"
                                    :placeholder="null"
                                    :options="uoms"
                        ...
                        <template #cell:rate="{ line }">
                            <TextInput v-model="line.rate" type="number" step="0.0001" numeric />
                        </template>
                        ...
                        <template #cell:lot="{ line }">
                            <div class="space-y-1">
                                <TextInput v-model="line.supplier_batch_no" placeholder="Supplier batch" />
                                ...
                                />
                                <TextInput v-model="line.roll_length_m" type="number" step="0.000001" placeholder="Roll length (m)" numeric />
                                <DateInput
                        ...
                        <template #cell:cert="{ line }">
                            <div class="space-y-1">
                                ...
                                <template v-if="line.cert_scheme">
                                    <TextInput v-model="line.cert_claim_pct" type="number" step="0.01" placeholder="Claim %" numeric />
                                    <TextInput v-model="line.cert_document_no" placeholder="Certificate / TC number" />
                                </template>
                            </div>
                        </template>
