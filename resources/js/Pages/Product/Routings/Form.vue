...
<template>
    <AppLayout>
        ...
        <template #actions>
            <Button href="/routings">Cancel</Button>
                ...
                <div class="p-3">
                    ...
                    >
                        <template #cell:operation="{ line }">
                            <div class="space-y-1">
                                <TextInput v-model="line.code" placeholder="weave" />
                                <TextInput v-model="line.name" placeholder="Weaving" />
                            </div>
                        </template>
                        ...
                        <template #cell:std_rate_per_hour="{ line }">
                            <TextInput v-model="line.std_rate_per_hour" type="number" step="0.000001" numeric />
                        </template>

                        <template #cell:setup="{ line }">
                            <div class="space-y-1">
                                <TextInput v-model="line.setup_minutes" type="number" step="0.01" placeholder="Setup minutes" numeric />
                                <TextInput v-model="line.setup_qty" type="number" step="0.000001" placeholder="Make-ready metres" numeric />
                            </div>
                        </template>
                        ...
                        <template #cell:manning_level="{ line }">
                            <TextInput v-model="line.manning_level" type="number" step="0.01" numeric />
                        </template>
